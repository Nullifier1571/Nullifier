...
import com.itjfr.jfr.adapter.WheelAdapter;
import com.itjfr.jfr.listener.OnWheelChangedListener;
import com.itjfr.jfr.listener.OnWheelScrollListener;
...
public class WheelView extends View {
	...
	private void initData(Context context) {
		...
		TEXT_SIZE = UITool.dip2px(context, TEXT_SIZE);
		ITEM_OFFSET = UITool.dip2px(context, ITEM_OFFSET);
	}
